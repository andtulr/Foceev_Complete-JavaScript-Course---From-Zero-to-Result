...
--- Методы атрибутов ---
 ...
 Полный список событий DOM  --------------- https://developer.mozilla.org/en-US/docs/Web/Events
 Обработчик события ---------- настроить поведение при срабатывании того или иного события
                               elem.AddEventListener('event', function(){})
elem         - элемент, полученный с помощью document.querySelector('elem');
'event'      - название события в кавычках
function(){} - функциональное выражение, в котором прописано то, что должно происходить после срабатывания события
